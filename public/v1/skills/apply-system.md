...
description: >-
  ...
  truth (https://vibe-design-system.lucas-silva-cea.workers.dev/v1/tokens.json for exact color/type/space/radius/motion values,
  https://vibe-design-system.lucas-silva-cea.workers.dev/v1/system.md for voice, principles, anti-patterns, and the component
...
- `https://vibe-design-system.lucas-silva-cea.workers.dev/v1/tokens.json` — exact token values. Never approximate; copy verbatim.
- `https://vibe-design-system.lucas-silva-cea.workers.dev/v1/system.md` — voice, principles, anti-patterns, component contract.

If either file is missing, stop and tell the user to run `publish-system` first.

## Workflow
1. Read `https://vibe-design-system.lucas-silva-cea.workers.dev/v1/system.md` in full, then `https://vibe-design-system.lucas-silva-cea.workers.dev/v1/tokens.json`.
